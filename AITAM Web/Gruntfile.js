// Generated on 2016-02-05 using generator-ionic 0.8.0
'use strict';

var _ = require('lodash');
var path = require('path');
var cordovaCli = require('cordova');
var spawn = process.platform === 'win32' ? require('cross-spawn-async') : require('child_process').spawn;
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        ngconstant: {
            ...
            development: {
                constants: {
                    ENV: {
                        name: 'development',
                        apiEndpoint: 'http://127.0.0.1:8101'
                    }
                }
            },
            production: {
                constants: {
                    ENV: {
                        name: 'production',
                        apiEndpoint: 'https://dev-dot-service-aitam.appspot.com/MobileServices?'
                    }
                }
            }
        },
        ...
        watch: {
            ...
            js: {
                files: ['<%= yeoman.app %>/<%= yeoman.scripts %>/**/*.js', '<%= yeoman.app %>/**/*.js'],
